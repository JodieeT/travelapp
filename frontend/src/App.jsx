...
import { HotelDetail as MerchantHotelDetail } from './pages/merchant/HotelDetail';
    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/merchant/hotels/:id" element={<ProtectedRoute allowedRoles={"merchant"}><MerchantHotelDetail /></ProtectedRoute>} />
          ...
          <Route path="/admin/hotels/:id" element={<ProtectedRoute allowedRoles={"admin"}><HotelDetail /></ProtectedRoute>} />
